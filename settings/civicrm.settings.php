...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@mysql:3306/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:root@mysql:3306/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/buildkit/civicrm-buildkit/build/drupal-clean/web/sites/all/modules/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/buildkit/civicrm-buildkit/build/drupal-clean/web/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost:7979');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'B0XwVh1JSRPUh5vt');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/vagrant/buildkit/build/drupal-clean/sites/default/files/civicrm/templates_c/mail.log');
// }
...
CRM_Core_ClassLoader::singleton()->register();
    ...
    if (file_exists($civibuild['PRJDIR'].'/src/civibuild.settings.php')) {
      require_once $civibuild['PRJDIR'].'/src/civibuild.settings.php';
      _civibuild_settings(__FILE__, 'civicrm.settings.d', $civibuild, 'post');
    }
